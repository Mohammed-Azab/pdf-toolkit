...
unlock file password="":
    {{python}} main.py unlock {{file}} --password {{password}}

split file mode="pages" output_dir="":
    {{python}} main.py split {{file}} --mode {{mode}} {{ if output_dir != "" { "--output-dir " + output_dir } else { "" } }}
